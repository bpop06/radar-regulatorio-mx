...
const ICON_DEFINITIONS = Object.freeze({
  ...
  "arrow-back": Object.freeze([node("path", { d: "M19 12H5M11 18l-6-6 6-6" })]),
  "arrow-forward": Object.freeze([node("path", { d: "M5 12h14M13 6l6 6-6 6" })]),
  "chevron-back": Object.freeze([node("path", { d: "m15 18-6-6 6-6" })]),
  "chevron-forward": Object.freeze([node("path", { d: "m9 18 6-6-6-6" })]),
  "chevron-down": Object.freeze([node("path", { d: "m6 9 6 6 6-6" })]),
  ...
  close: Object.freeze([node("path", { d: "M6 6l12 12M18 6 6 18" })]),
...
function resolveIconName(name) {
  ...
  const canonical = ICON_ALIASES[requested] || requested;
  if (!Object.hasOwn(ICON_DEFINITIONS, canonical)) throw new RangeError(`Icono desconocido: ${name}`);
...
function buildIcon(documentRef, name, options = {}) {
  ...
  for (const spec of ICON_DEFINITIONS[canonical]) {
    ...
    for (const [attribute, value] of Object.entries(spec.attributes)) child.setAttribute(attribute, value);
    svg.append(child);
  }
  return svg;
}
