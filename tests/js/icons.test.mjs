...
const expectedNames = [
  "today", "archive", "calendar", "sun", "moon", "date", "file", "external",
  "arrow-back", "arrow-forward", "chevron-back", "chevron-forward", "chevron-down",
  "search", "sliders", "close", "refresh", "book", "coverage-ok", "coverage-warning",
  "signal", "x",
];
